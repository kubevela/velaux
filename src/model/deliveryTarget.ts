...
const DeliveryTargets: ModelsType = {
  ...
  reducers: {
    updateDeliveryTargets(state: State, { payload }: { payload: { deliveryTargets: {}, total: number } }) {
  ...
  effects: {
    ...
    *createDeliveryTarget(action: { payload: {}, callback: (parasm: any) => void }, { call, put }: { call: any, put: any }) {
