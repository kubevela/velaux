...
export const managerTitle = '应用管理';
export const managerName = '应用名称-';
export const managerSubTitle = '云原生应用、多集群应用统一管理';
export const addApp = '新增应用';
...
export const pluginSubTitle = '统一管理组件类型扩展、集群治理能力扩展和系统插件扩展等插件, 用户可获取社区丰富的扩展能力';
