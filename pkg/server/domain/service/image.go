...
type ImageService interface {
	...
	ValidateImageRepoSecret(ctx context.Context, project string, req v1.CreateConfigRequest) (*v1.ValidateRepoResponse, error)
...
func (i *imageImpl) ValidateImageRepoSecret(ctx context.Context, project string, req v1.CreateConfigRequest) (*v1.ValidateRepoResponse, error) {
	...
	return &v1.ValidateRepoResponse{Ok: true}, nil
}
...
func (i *imageImpl) GetRepositoryTags(ctx context.Context, project, secretName, repository string) (*registries.RepositoryTags, error) {
	...
	if err != nil {
		klog.Errorf("fail to list repository tags:%s", err.Error())
		return nil, err
	}
