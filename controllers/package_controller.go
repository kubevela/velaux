...
// +kubebuilder:rbac:groups=velacp.oam.dev.velacp.oam.dev,resources=packages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=velacp.oam.dev.velacp.oam.dev,resources=packages/status,verbs=get;update;patch
...
func (r *PackageReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&velacpoamdevv1alpha1.Package{}).
		Complete(r)
}
