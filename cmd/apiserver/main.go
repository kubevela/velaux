...
func NewDashboardCommand(c common.Args) *cobra.Command {
	var o Options
	//o.frontendSource = frontendSource
	cmd := &cobra.Command{
		Hidden:     true,
		Use:        "server",
		Short:      "Setup API Server",
		Long:       "Setup API Server",
		Example:    `dashboard`,
		Deprecated: "launch APIServer",
...
func main() {
	...
	app.AddCommands(
		NewDashboardCommand(commandArgs),
	)
