...
// +kubebuilder:rbac:groups=velacp.oam.dev.velacp.oam.dev,resources=catalogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=velacp.oam.dev.velacp.oam.dev,resources=catalogs/status,verbs=get;update;patch
...
func (r *CatalogReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&velacpoamdevv1alpha1.Catalog{}).
		Complete(r)
}
