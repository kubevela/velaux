                            ...
                            <Card>
                                <div className='traits-list-nav'>
                                    ...
                                    <div className='traits-list-operation'>
                                        <Icon type='wind-minus' size='small' className='margin-right-5 cursor-pointer' onClick={() => { this.handleDelete(item.type || '') }} />
                                        <Icon type='set' size='small' className='cursor-pointer' onClick={() => { changeTraitStats(true, item) }} />
                                    </div>
                                </div>
