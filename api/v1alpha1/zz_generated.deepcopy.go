...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateType) DeepCopyInto(out *TemplateType) {
	*out = *in
	if in.Components != nil {
		in, out := &in.Components, &out.Components
		*out = make([]v1alpha2.ApplicationComponent, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateType.
func (in *TemplateType) DeepCopy() *TemplateType {
	if in == nil {
		return nil
	}
