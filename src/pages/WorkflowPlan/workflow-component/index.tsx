...
class WorkFlowComponent extends Component<Props, State> {
    ...
    saveWorkflow = (name: string) => {
        ...
        //   const { description, alias } = this.state;
    ...
    render() {
        ...
        return (
            <div className={errorFocus ? "workflow-component-container error" : "workflow-component-container"} id={data.name}>
                            ...
                            <div className="workflow-description">
                                <Form field={this.field} inline >
                                    <Form.Item required label="工作流名称">
                                        <Input className="input" {...init('name', {
                                            initValue: data.name, rules: [{
                                                required: true,
                                                pattern: checkName,
                                    ...
                                    <Form.Item label="描述">
                                        <Input className="input" {...init('description', { initValue: data.description })} />
                                    </Form.Item>
                                </Form>
                            </div>
                        </If>
